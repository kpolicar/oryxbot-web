...
@section('title', 'v0.5 - Release Notes')
...
@section('hero')
    <x-main-hero>
        ...
        <h2 class="tracking-loose text-xl w-full font">v0.5 <span class="uppercase">Beta</span></h2>
        <h1 class="mb-0 text-5xl font-bold leading-tight">Release notes</h1>
        <h2 class="mb-4 font-bold tracking-loose text-lg w-full font">22nd April 2021</h2>
        <p class="leading-normal text-lg mb-2">
            Welcome to the fifth release of Oryxbot!
        </p>
        <p class="leading-normal text-lg mb-2">
...
@section('content')
    ...
    <section class="bg-gray-900 py-8">
        ...
        <div class="container mx-auto pt-4 pb-12">
                ...
                <div class="mx-auto flex flex-col w-full lg:w-3/5 p-6 px-4">
                    ...
                    <ul class="text-gray-500 p-6 px-4 -mx-2 rounded-lg">
                        <li class="py-3 flex">
                            ...
                            <span>
                                Improved the <strong class="text-gray-300">custom route recording</strong> process,
                                users now need only start the recording, take the quest, run the route and the
                                bot will automatically stop the recording once the quest is complete
                            </span>
                        </li>
                        <li class="py-3 flex">
                            <i class="fas fa-plus text-3xl mr-3 text-gray-200"></i>
                            <span>
                                Added <strong class="text-gray-300">user interface</strong> for the route recording
                                process
                            </span>
                        </li>
                        <li class="py-3 flex">
                            <i class="fas fa-plus text-3xl mr-3 text-gray-200"></i>
                            <span class="pt-1">Fix the <strong class="text-gray-300">pause/resume</strong> function</span>
                        </li>
                        <li class="py-3 flex">
                            <i class="fas fa-plus text-3xl mr-3 text-gray-200"></i>
                    ...
                    <ul class="text-gray-500 p-6 px-4 -mx-2 rounded-lg">
                        <li class="py-3 flex">
                            ...
                            <span class="pt-1">Add even more <strong class="text-gray-300">trade mission locations</strong></span>
                        </li>
                        <li class="py-3 flex">
                            <i class="fas fa-clock text-3xl mr-3 text-gray-200"></i>
            ...
            <a href="{{ route('release', ['version' => 'v0.4beta']) }}" class="flex items-center group" style="width: fit-content">
