...
@section('title', 'v0.6 - Release Notes')
...
@section('hero')
    <x-main-hero>
        ...
        <h2 class="tracking-loose text-xl w-full font">v0.6 <span class="uppercase">Beta</span></h2>
        <h1 class="mb-0 text-5xl font-bold leading-tight">Release notes</h1>
        <h2 class="mb-4 font-bold tracking-loose text-lg w-full font">1st May 2021</h2>
        <p class="leading-normal text-lg mb-2">
            Welcome to the sixth release of Oryxbot!
        </p>
        <p class="leading-normal text-lg mb-2">
...
@section('content')
    ...
    <section class="bg-gray-900 py-8">
        ...
        <div class="container mx-auto pt-4 pb-12">
                ...
                <div class="mx-auto flex flex-col w-full lg:w-3/5 p-6 px-4">
                    ...
                    <ul class="text-gray-500 p-6 px-4 -mx-2 rounded-lg">
                        <li class="py-3 flex">
                            ...
                            <span>
                                Added <strong class="text-gray-300">user interface</strong> for the trade mission run
                                with information about the bot's state
                            </span>
                        </li>
                        <li class="py-3 flex">
                            <i class="fas fa-plus text-3xl mr-3 text-gray-200"></i>
                        ...
                        <li class="py-3 flex">
                            <i class="fas fa-plus text-3xl mr-3 text-gray-200"></i>
                            <span>
                                Improved behavior for when the <strong class="text-gray-300">bot is stuck</strong>
                            </span>
                        </li>
                        <li class="py-3 flex">
                            <i class="fas fa-plus text-3xl mr-3 text-gray-200"></i>
                        ...
                        <li class="py-3 flex">
                            <i class="fas fa-plus text-3xl mr-3 text-gray-200"></i>
                            <span>
                                General <strong class="text-gray-300">quality of life</strong> improvements and
                                <strong class="text-gray-300">bug fixes</strong>
                            </span>
                        </li>
                    </ul>
            ...
            <a href="{{ route('release', ['version' => 'v0.5beta']) }}" class="flex items-center group" style="width: fit-content">
