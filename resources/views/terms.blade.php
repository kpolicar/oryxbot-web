    ...
    <x-main-hero>
        ...
        <div class="flex flex-col-reverse">
            <div class="flex flex-col lg:flex-row justify-between">
                ...
                <i class="fas fa-balance-scale text-5xl p-2"></i>
            </div>
        ...
        <p class="leading-normal text-lg mb-2">
            By using the services provided by Oryxbot, you must agree to the Terms of service, as defined below.
        </p>
...
@section('content')
    <section class="bg-gray-900 py-8">
        <div class="container mx-auto pt-4 pb-12 text-gray-500">
            ...
            <p class="my-2">
                ...
                behalf of an entity ("<b>you</b>") and Oryxbot ("<b>Company</b>", "<b>we</b>", "<b>us</b>", or "<b>our</b>"),
                concerning your access to and use of the
                <a href="{{ route('home') }}" class="text-gray-400 font-bold hover:underline">https://oryxbot.com</a>
            ...
            <p class="my-2">
                ...
                <a href="mailto:payment@oryxbot.com" class="font-bold">payment@oryxbot.com</a>.
            </p>
