...
<head>
    ...
    <!-- Styles -->
    <link rel="stylesheet" href="{{ asset('app.css', 'vendor/nova') }}">
...
<body class="min-w-site bg-40 text-90 font-medium min-h-full">
    ...
    <!-- Scripts -->
    <script src="{{ asset('manifest.js', 'vendor/nova') }}"></script>
    <script src="{{ asset('vendor.js', 'vendor/nova') }}"></script>
    <script src="{{ asset('app.js', 'vendor/nova') }}"></script>
